...
function quick_partition (start, end)
{
    ...
    div_update(divs[start],div_sizes[start],"#E2F4C5");//Color update
        ...
        for(var j =start + 1; j <= end ; j++ )
        {
            ...
            if (div_sizes[ j ] < piv)
            {
                ...
                div_update(divs[j],div_sizes[j],"#A8CD9F");//Color update
                ...
                div_update(divs[j],div_sizes[j],"#A8CD9F");//Height update

                div_update(divs[i],div_sizes[i],"#26355D");//Height update
                div_update(divs[j],div_sizes[j],"#26355D");//Height update

                i += 1;
            }
    }
    div_update(divs[start],div_sizes[start],"#A8CD9F");//Color update
    ...
    div_update(divs[start],div_sizes[start],"#A8CD9F");//Height update
